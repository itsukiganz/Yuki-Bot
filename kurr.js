...
│❒ ${prefix}upswvoice [ _reply audio_ ]_
│❒ ${prefix}upswsticker [ _reply sticker_ ]_
│❒ ${prefix}upswimage [ _reply image with caption_ ]_
│❒ ${prefix}upswgif [ _reply gif with caption_ ]_
│❒ ${prefix}upswvideo [ _reply video with caption_ ]_
│❒ ${prefix}shutdown_
│❒ ${prefix}offline [ _alasan_ ]_
│❒ ${prefix}online_
│❒ ${prefix}exif [ _nama|author_ ]_
│❒ ${prefix}setprofile [ _reply image_ ]_
...
│❒ ${prefix}pin
│❒ ${prefix}unpin
│❒ ${prefix}setmenu [ _ori/simpel_ ]_
│❒ ${prefix}setallmenu [ _ori/simpel_ ]_
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=${lolkey}&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `DONE, Jangan Bully aku om 🗿`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
...
kurr.sendMessage(from, {url: `${pint[Math.floor(Math.random() * pint.length)]}`}, image, {quoted: mek, thumbnail: Buffer.alloc(0), caption: "DONE, Jangan Bully aku om 🗿"})
break
case 'isbaileys': 
case 'bail': 
case 'baileys':
...
break
              ...
              reply(`Bentar Nyett....`)
					...
					kurr.sendMessage(from, buff, image, {thumbnail: Buffer.alloc(0), caption: `DONE, Jangan Bully aku om 🗿`, quoted : ftrol})
					break
				break
				case 'addsticker':
				if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
